...
public class FileStatus {
     ...
     */
    public static FileStatus getStatusForString(final String statusString) {
    ...
    /**
     * The Added status, i.e. the file has been added to the repository but not
     * committed yet.
     */
    ...
    /**
     * The locally modified status, i.e. the file has been modified locally and
    ...
    /**
     * The "needs merge" status, i.e. the file is locally modified and the file
     * in the repository has been modified too
     */
    public static final FileStatus NEEDS_MERGE = new FileStatus("Needs Merge"); // NOI18N

    /**
     * The "conflicts" status, i.e. the file has been merged and now has
     * conflicts that need resolved before it can be checked-in
     */
