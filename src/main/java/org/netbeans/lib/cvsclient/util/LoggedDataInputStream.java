...
public class LoggedDataInputStream extends FilterInputStream {
    ...
    /**
     * Read a line (up to the newline character) from the stream, logging it
     * too.
     * 
     * @deprecated It converts input data to string using
     *             {@link ByteArray#getStringFromBytes} that works only for
     *             ASCII without <tt>0</tt>. Use <tt>byte</tt> access methods
     *             instead.
     */
    @Deprecated
    ...
    public void setUnderlyingStream(final InputStream is) {
        in = is;
    }
