...
public class LoggedDataOutputStream extends FilterOutputStream {
     ...
     * 
     * @deprecated Line to to bytes conversion is host specifics. Use raw byte
     *             access methods insted.
     * 
     */
    @Deprecated
    public void writeChars(final String line) throws IOException {
        writeBytes(line);
    }
     ...
     * 
     * Line to to bytes conversion is host specifics. Use
     * {@link #writeBytes(String, String)} if possible.
     */
    public void writeBytes(final String line) throws IOException {
     ...
     * Write a line to the stream, logging it too.
     */
    public void writeBytes(final String line, final String encoding) throws IOException {
        final byte[] bytes = line.getBytes(encoding);
        out.write(bytes);
        Logger.logOutput(bytes);
        counter += bytes.length;
    }
    ...
    public void setUnderlyingStream(final OutputStream os) {
        out = os;
    }
