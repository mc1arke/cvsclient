 ...
 * Connection classes.
 * 
 * @author <a href="mailto:gerrit.riessen@wiwi.hu-berlin.de">Gerrit Riessen</a>,
 *         OAR Development AG
 * @author <a href="mailto:rami.ojares@elisa.fi">Rami Ojares</a>, Elisa Internet
 *         Oy
 */
public class ConnectionFactory {
     ...
     * This returns null if not suitable connection was found.
     * 
     * If the return value is an instance of the PServerConnection class, then
     * the encoded password needs to be set if not defined in the CVSRoot. This
     * is left up to the client to set.
     */
    public static Connection getConnection(final String cvsRoot) throws IllegalArgumentException {

        final CVSRoot root = CVSRoot.parse(cvsRoot);
     ...
     * is left up to the client to set.
     */
    public static Connection getConnection(final CVSRoot root) throws IllegalArgumentException {

        // LOCAL CONNECTIONS (no-method, local & fork)
        if (root.isLocal()) {
            final LocalConnection con = new LocalConnection();
