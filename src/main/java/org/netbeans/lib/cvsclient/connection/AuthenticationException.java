 ...
 * for whatever reason. It may be that the username and/or password are
 * incorrect or it could be that the port number is incorrect. Note that
 * authentication is not restricted here to mean security.
 * 
 * @author Robert Greig
 */
public class AuthenticationException extends Exception {
     ...
     * 
     */
    private static final long serialVersionUID = -8658266253347848470L;
     ...
     **/
    public AuthenticationException(final String message, final String localizedMessage) {
        super(message);
     ...
     */
    public AuthenticationException(final String message, final Throwable underlyingThrowable,
     ...
     */
    public AuthenticationException(final Throwable underlyingThrowable, final String localizedMessage) {
        this.localizedMessage = localizedMessage;
        initCause(underlyingThrowable);
    }
    ...
    protected static String getBundleString(final String key) {
        String value = null;
        try {
            final ResourceBundle bundle = BundleUtilities.getResourceBundle(AuthenticationException.class, "Bundle"); // NOI18N
            if (bundle != null) {
