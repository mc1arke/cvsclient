 ...
 * communicate using the CVS Protocol. Instances of this interface are used by
 * the Client class to communicate with the server without being too concerned
 * with how the communication is taking place or how it was set up.
 * 
...
public interface Connection extends Serializable {
     ...
     * communication with the server can take place. This Client will call this
     * method before interacting with the server. It is up to implementing
     * classes to ensure that they are configured to talk to the server (e.g.
     * port number etc.)
     * 
     ...
     * acceptable. Does not create input and output stream. For that, use the
     * open() method.
     */
     ...
     * 
     * @return The port number or zero, when the port number does not have
     *         sense.
     */
    int getPort();
