 ...
 * information about different connection methods. Local is popular where the
 * CVS repository exists on the machine where the client library is running.
 * <p>
 * Because this library implements just the client part, it can not operate
 * directly on the repository. It needs a server to talk to. Therefore it needs
 * to execute the server process on the local machine.
 * 
 * @author Robert Greig
 */
public class LocalConnection extends AbstractConnection {
     ...
     * 
     */
    private static final long serialVersionUID = -482793009009950919L;

    private static final String CVS_EXE_COMMAND = System.getenv("CVS_EXE") != null ? System.getenv("CVS_EXE")
                    + " server" : "cvs server"; // NOI18N
    ...
    private void openConnection() throws AuthenticationException {
        try {
            ...
            reset();
            final String locMessage = AuthenticationException
                            .getBundleString("AuthenticationException.ServerConnection"); // NOI18N
    ...
    public void verify() throws AuthenticationException {
        try {
            ...
            final String locMessage = AuthenticationException
                            .getBundleString("AuthenticationException.ServerVerification"); // NOI18N
