...
/**
 * The provider of CVS commands. The implementation of this interface knows how
 * to create a CVS command from an array of arguments.
 * 
...
abstract class AbstractCommandProvider implements CommandProvider {
    ...
    /**
     * Get the name of this command. The default implementation returns the name
    ...
    public void printShortDescription(final PrintStream out) {
        final String msg = ResourceBundle.getBundle(CommandProvider.class.getPackage().getName() + ".Bundle")
                        .getString(getName() + ".shortDescription"); // NOI18N
        out.print(msg);
    }

    public void printLongDescription(final PrintStream out) {
        final String msg = ResourceBundle.getBundle(CommandProvider.class.getPackage().getName() + ".Bundle")
                        .getString(getName() + ".longDescription"); // NOI18N
