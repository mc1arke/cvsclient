...
/**
 * Contains intercepted infomation from command standard output. Actula data are
 * held in temporary file.
 * 
 */
public class PipedFileInformation extends FileInfoContainer {
    ...
    public PipedFileInformation(final File tempFile) {
     ...
     */
    protected void addToTempFile(final byte[] bytes) throws IOException {
        if (tmpStream != null) {
     ...
     * Adds the specified line to the temporary file.
     */
    public void addToTempFile(final byte[] bytes, final int len) throws IOException {
        if (tmpStream != null) {
