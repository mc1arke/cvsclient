...
public class RlogCommand extends BasicCommand {
     ...
     * 
     */
    private static final long serialVersionUID = 2344848248522928974L;
     ...
     *            latest revision of default branch.
     */
     ...
     * 
     * @return Value of property userFilter, empty string means the current
     *         user.
     */
    ...
    public String getCVSCommand() {
        final StringBuffer toReturn = new StringBuffer("rlog "); // NOI18N
