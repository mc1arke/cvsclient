...
/**
 * Describes remove information for a file. This is the result of doing a cvs
 * remove command. The fields in instances of this object are populated by
 * response handlers.
 * 
 * @author Milos Kleint
 */
public class RemoveInformation extends FileInfoContainer {
    ...
    public void setRemoved(final boolean rem) {
        removed = rem;
    }
