...
/**
 * This exception is thrown when an error occurs while executing a command. It
 * is nearly always a container for another exception.
 * 
 * @author Robert Greig
 */
public class CommandException extends Exception {
     ...
     * 
     */
    private static final long serialVersionUID = -4281436477286133907L;
    ...
    public CommandException(final String message, final String localizedMessage) {
        super(message);
    ...
    protected static String getBundleString(final String key) {
        String value = null;
        try {
            final ResourceBundle bundle = BundleUtilities.getResourceBundle(CommandException.class, "Bundle"); // NOI18N
            if (bundle != null) {
    ...
    public static String getLocalMessage(final String key) {
        return getLocalMessage(key, null);
    }

    public static String getLocalMessage(final String key, final Object[] arguments) {
