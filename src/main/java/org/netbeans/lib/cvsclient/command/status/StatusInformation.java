...
/**
 * Describes status information for a file. This is the result of doing a cvs
 * status command. The fields in instances of this object are populated by
 * response handlers.
 * 
 * @author Robert Greig
 */
public class StatusInformation extends FileInfoContainer {
    ...
    /**
     * Returns the status as a String. The String returned are definitely the
    ...
    public void addExistingTag(final String tagName, final String revisionNumber) {
    ...
    public void setAllExistingTags(final List<SymName> tags) {
        this.tags = tags;
    }
    ...
    public List<SymName> getSymNamesForRevision(final String revNumber) {
        ...
        for (final SymName symName : tags) {
            final StatusInformation.SymName item = symName;
     ...
     * return null.
     */
    public StatusInformation.SymName getSymNameForTag(final String tagName) {
        if (tags == null) {
            createSymNames();
        }
    ...
    /**
     * An inner class storing information about a symbolic name. Consists of a
     * pair of Strings. tag + revision.
     */
    public static class SymName {
        ...
        public void setTag(final String symName) {
            tag = symName;
        }
