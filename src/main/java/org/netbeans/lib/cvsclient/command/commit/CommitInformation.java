...
/**
 * Describes commit information for a file. This is the result of doing a cvs
 * commit command. The fields in instances of this object are populated by
 * response handlers.
 * 
 * @author Milos Kleint
 */
public class CommitInformation extends DefaultFileInfoContainer {
    ...
    /**
     * The new revision (for "Added" and "Changed") or old revision (for
     * "Removed").
     */
