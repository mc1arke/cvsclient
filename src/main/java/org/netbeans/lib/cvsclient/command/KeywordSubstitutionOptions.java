 ...
 */
public final class KeywordSubstitutionOptions implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 3056205942422933248L;
    ...
    public static KeywordSubstitutionOptions findKeywordSubstOption(final String keyword) {
