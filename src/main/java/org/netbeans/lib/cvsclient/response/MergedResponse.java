...
/**
 * This response is very similar to an UpdatedResponse except that it backs up
 * the file being merged, and the file in question will still not be up-to-date
 * after the merge.
 * 
 * @author Robert Greig
...
class MergedResponse extends UpdatedResponse {
    ...
    public void process(final LoggedDataInputStream dis, final ResponseServices services) throws ResponseException {
        ...
        final EventManager manager = services.getEventManager();
