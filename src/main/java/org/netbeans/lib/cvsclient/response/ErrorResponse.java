...
public class ErrorResponse implements Response {
     ...
     * 
     */
    private static final long serialVersionUID = -326315044605374764L;
    ...
    public void process(final LoggedDataInputStream dis, final ResponseServices services) throws ResponseException {
        try {
            final MessageEvent event = new MessageEvent(this, dis.readLine(), true);
            services.getEventManager().fireCVSEvent(event);
            final TerminationEvent termEvent = new TerminationEvent(this, true);
