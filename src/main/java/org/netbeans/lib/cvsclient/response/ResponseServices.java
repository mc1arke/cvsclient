...
public interface ResponseServices {
    ...
    /**
     * Get the modified date of the next file to be written. This will also null
     * any stored date so that future calls will not retrieve a date that was
     * meant for a previous file.
     * 
     ...
     * if necessary. It will also update the Entries file with the new entry
     * 
     * @param localDirectory
     ...
     * 
     * @param pathname
     *            the full path to the file to coyp
     * @param newname
     *            the new name of the file (not the full path)
     * @throws IOException
     *             if an IO error occurs while copying the file
     */
