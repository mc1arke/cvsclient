...
public class NotifyRequest extends Request {
     ...
     * 
     */
    private static final long serialVersionUID = 4607250065015531801L;
    ...
    /**
     * Creates an NotifyRequest for the specified file. If the specified file is
     * null, a IllegalArgumentException is thrown.
     */
    public NotifyRequest(final File file, final String command, final String parameters) {
        if (file == null) {
