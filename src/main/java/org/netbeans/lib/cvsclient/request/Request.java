...
public abstract class Request implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 7253589867439325628L;
     ...
     * file to transmit after the request string. The default implementation
     * returns null, indicating no file is to be transmitted
     * 
     * @return the file object, if one should be transmitted, or null if no file
     *         object is to be transmitted.
     */
