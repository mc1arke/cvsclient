...
/**
 * The Argument request. The server saves the specified argument for use in a
 * future argument-using command
 * 
 * @author Robert Greig
 */
public class ArgumentRequest extends Request {
     ...
     * @param theArgument
     *            the argument to use
     * @param escapeLeadingDash
     *            true to escape leasding dash in the argument with another "--"
     *            Argument request, false otherwise
     */
    public ArgumentRequest(final String argument, final boolean escapeLeadingDash) {
