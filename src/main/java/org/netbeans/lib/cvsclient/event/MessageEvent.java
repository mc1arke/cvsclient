...
public class MessageEvent extends CVSEvent {
    ...
    public MessageEvent(final Object source, final String message, final byte[] raw, final boolean isError) {
        super(source);
        setMessage(message);
        setError(isError);
        setTagged(false);
     ...
     *            stderr rather than stdout), false otherwise
     */
    public MessageEvent(final Object source, final String message, final boolean isError) {
     ...
     *            the source of the event
     */
    public MessageEvent(final Object source) {
     ...
     */
    public static String parseTaggedMessage(final StringBuffer taggedLineBufferNotNull, final String taggedMessage) {
        final String line = taggedMessage;
