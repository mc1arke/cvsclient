...
public class FileInfoEvent extends CVSEvent {
     ...
     * 
     */
    private static final long serialVersionUID = 4519889700049622628L;
    /**
     ...
     */
    public FileInfoEvent(final Object source, final FileInfoContainer infoContainer) {
        super(source);
     ...
     * 
     * @return the information object describing a file's info received from the
     *         server
     */
