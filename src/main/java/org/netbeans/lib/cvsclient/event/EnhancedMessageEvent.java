...
public class EnhancedMessageEvent extends MessageEvent {
     ...
     * 
     */
    private static final long serialVersionUID = 3847291423219537057L;

    /**
     * Sent by MergedResponse when 2 files were merged. The value is a String
     * instance that tells the full path to the file.
     */
    ...
    /**
     * Sent when a all requests were sent to server. Value is a String with
     * value of "ok".
     */
    ...
    public EnhancedMessageEvent(final Object source, final String key, final Object value) {
